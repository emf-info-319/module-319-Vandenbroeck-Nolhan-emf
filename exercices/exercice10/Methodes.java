...
public class Methodes {
    ...
    public static void main(String[] args) {
        ...
        int moyenneValeursTab = moyenneValeurs(newTab);
    ...
    public static int[] remplirTab(int[] tab, int valeurMax) {
        ...
        tab[i] = random.nextInt(valeurMax + 1); 
    }
        return tab;
    }
    ...
    public static void contenuTab(int[] tab, String[] args) {
        for (int i = 0; i < tab.length; i++) {
    ...
    public static int sommeValeurs(int[] tab) {
     ...
     public static int moyenneValeurs(int[] tab) {
        int totalValeurs = 0;
        for (int i = 0; i < tab.length; i++) {
            totalValeurs += tab[i];
        }
